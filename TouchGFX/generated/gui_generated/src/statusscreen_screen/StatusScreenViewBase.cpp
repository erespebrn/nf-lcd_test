...
StatusScreenViewBase::StatusScreenViewBase() :
    flexButtonCallback(this, &StatusScreenViewBase::flexButtonCallbackHandler)
{
    ...
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_QX1S));
    add(textArea1);
...
void StatusScreenViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &backButton)
    {
        //backToMenu
