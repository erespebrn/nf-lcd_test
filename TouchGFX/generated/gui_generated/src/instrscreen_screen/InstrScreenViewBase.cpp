...
InstrScreenViewBase::InstrScreenViewBase() :
    flexButtonCallback(this, &InstrScreenViewBase::flexButtonCallbackHandler)
{
    ...
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_0GW3));
    add(textArea1);
...
void InstrScreenViewBase::setupScreen()
{

}

void InstrScreenViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &backButton)
    {
        //backToMenu
